...
echo 6: launch modded chivalry
echo 7: exit
choice /n /c 1234567 /m "Select an option: "
...
call :listMods
echo.
echo NOTE: If the asset loader plugin is not installed, it will be installed automatically when you install a mod.
